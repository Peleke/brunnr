...
??? note "View findings"
    ...
    |-------------|----------|-------------|------|
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: fonts.googleapis.com | 202 |
...
| Property | Value |
|----------|-------|
| **Path** | `skills/slidev-deck/SKILL.md` |
| **Size** | 42.3 KB |
| **SHA-256** | `887cd6c8b552ab893f5b9139dbc1ec46e961e50d1135d954543fe97240ba54c5` |
