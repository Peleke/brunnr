...
Analyze educational content and inject architectural scaffolding: designed failures, skeleton-first stubs, accumulation artifacts, reading strategies, troubleshooting callouts, and bonus depth labels. Runs after outline-writer or notebook-builder, before engagement-pass.
...
| Property | Value |
|----------|-------|
| **Path** | `skills/scaffold-pass/SKILL.md` |
| **Size** | 18.9 KB |
| **SHA-256** | `fca42300cef7af74d426562771fbfc6cbd1b0d31abea208b0cb61b845bb8cbcc` |
