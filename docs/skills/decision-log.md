...
Structured product decision engine -- takes signal scan output and operator preferences, applies the Signal-to-Decision Pipeline (SDP) framework, and produces a scored, filtered, bias-checked decision record with pre-mortem analysis and kill criteria. Use when choosing which opportunity to pursue from a completed signal scan.
...
| **Size** | 19.0 KB |
| **SHA-256** | `78e8fd3b15eb0837a61c584be9810e15f805de7f4ba7ea4d71610b8ffca8fac5` |
| **README** | `skills/decision-log/README.md` |
