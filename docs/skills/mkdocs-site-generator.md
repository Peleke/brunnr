...
**Binaries:** `python3`, `pip`, `gh`

## Install

```bash
brunnr install mkdocs-site-generator
```
...
??? note "View findings"
    ...
    |-------------|----------|-------------|------|
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: unpkg.com | 417 |
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: {owner}.github.io | 535 |
...
| Property | Value |
|----------|-------|
| **Path** | `skills/mkdocs-site-generator/SKILL.md` |
| **Size** | 18.8 KB |
| **SHA-256** | `1ba7da65b8b56cdc063efe8e930c76fb869aacbaaceecfa1b0991f51cf22d0b0` |
