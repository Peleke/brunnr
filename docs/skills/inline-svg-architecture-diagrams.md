...
Generate production-quality inline SVG architecture diagrams with theme-aware CSS variables, animated flow lines, glow effects, feedback loops, and responsive layout. No external dependencies, no build steps, no image files. Use when creating system architecture visuals that integrate with a design system.

---

**License:** Complete terms in LICENSE.txt | **Security:** INFO (2)


## Install

```bash
brunnr install inline-svg-architecture-diagrams
```
...
??? note "View findings"
    ...
    |-------------|----------|-------------|------|
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: www.w3.org | 667 |
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: www.w3.org | 688 |
...
| Property | Value |
|----------|-------|
| **Path** | `skills/inline-svg-architecture-diagrams/SKILL.md` |
| **Size** | 28.4 KB |
| **SHA-256** | `d3a5417c867d4bf50d8d9984db3b871abbd20637fff486f052e63b2e975c60e3` |
