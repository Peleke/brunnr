...
```bash
brunnr install assessment-generator
```
...
| Property | Value |
|----------|-------|
| **Path** | `skills/assessment-generator/SKILL.md` |
| **Size** | 22.8 KB |
| **SHA-256** | `e56390c1354f76ac78b74787da1cb8423edfc4d691c480ef78f26ecd1cbd4213` |
