...
??? note "View findings"
    ...
    |-------------|----------|-------------|------|
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: www.w3.org | 71 |
...
| Property | Value |
|----------|-------|
| **Path** | `skills/sketches/SKILL.md` |
| **Size** | 9.3 KB |
| **SHA-256** | `25075cb27f50c325e8bff9590dd4a8c83bdbf61b9467124d12993252ba3a463a` |
