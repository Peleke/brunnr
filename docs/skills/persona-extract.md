...
```bash
brunnr install persona-extract
```
...
| Property | Value |
|----------|-------|
| **Path** | `skills/persona-extract/SKILL.md` |
| **Size** | 17.4 KB |
| **SHA-256** | `0270c51dd45f5fca2c54c99d7ffc5c354da13d24b887dab639fd8d3aa64f89ac` |
| **README** | `skills/persona-extract/README.md` |
