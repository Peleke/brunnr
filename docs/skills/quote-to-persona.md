...
```bash
brunnr install quote-to-persona
```
...
| Property | Value |
|----------|-------|
| **Path** | `skills/quote-to-persona/SKILL.md` |
| **Size** | 21.8 KB |
| **SHA-256** | `5c7f05a8800ffb7af1ff2fb61f7ab18b52980ab2e2a672ea936380431bc44970` |
