...
??? note "View findings"
    ...
    |-------------|----------|-------------|------|
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: api.traveladvisory.io | 5 |
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: api.traveladvisory.io | 17 |
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: api.traveladvisory.io | 299 |
...
| Property | Value |
|----------|-------|
| **Path** | `skills/travel-pulse/SKILL.md` |
| **Size** | 11.0 KB |
| **SHA-256** | `3307aa515ee611065dd78cde4edfcec2d48448a0b96726ce4d3af8d68b07976b` |
| **README** | `skills/travel-pulse/README.md` |
