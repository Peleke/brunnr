...
```bash
brunnr install lesson-generator
```
...
| Property | Value |
|----------|-------|
| **Path** | `skills/lesson-generator/SKILL.md` |
| **Size** | 57.9 KB |
| **SHA-256** | `b62eb6b4dec659e2985a7276086b4422e52510a454c46abbc14a5d7ded611cb9` |
| **README** | `skills/lesson-generator/README.md` |
