...
```bash
brunnr install linwheel-source-optimizer
```
...
| Property | Value |
|----------|-------|
| **Path** | `skills/linwheel-source-optimizer/SKILL.md` |
| **Size** | 12.8 KB |
| **SHA-256** | `8e82d28c7182b0e76bce71e01465368090a7a1c6a07ce5a2d949e23646aac1c0` |
