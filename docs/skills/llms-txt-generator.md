...
```bash
brunnr install llms-txt-generator
```
...
??? note "View findings"
    ...
    |-------------|----------|-------------|------|
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: llmstxt.org | 127 |
    | `semantic_mismatch` | **INFO** | URL to non-allowlisted domain: llmstxt.org | 435 |
...
| **Size** | 12.2 KB |
| **SHA-256** | `252f9f585c6a21d855667f803704122e3f425236a57a3651b8b4b849f4522af8` |
