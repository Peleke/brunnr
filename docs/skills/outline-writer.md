...
Create detailed narrative outlines for notebook modules through riffing and structured discovery. Triggers on "outline module", "riff on module", "plan module", "outline for", or when preparing to generate a new notebook.
...
| Property | Value |
|----------|-------|
| **Path** | `skills/outline-writer/SKILL.md` |
| **Size** | 8.0 KB |
| **SHA-256** | `b2365040472f518e6376c70aa54176dae414453a13c0bedfbd9e988749455112` |
